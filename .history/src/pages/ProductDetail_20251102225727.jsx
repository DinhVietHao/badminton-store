...
import { Container, Row, Col, Image, Button, Tabs, Tab, Spinner, Alert } from "react-bootstrap";
      ...
      <Row className="g-4">
        ...
        <Col md={5}>
          ...
          <div className="d-flex mt-3 gap-2 justify-content-center">
            {[product.thumbnailUrl, ...(product.gallery || [])].map((img, i) => (
              <div
                key={i}
        ...
        <Col md={7}>
          ...
          <div className="text-muted mb-3">
            Thương hiệu: <span className="fw-semibold text-dark">{product.brand}</span>
          </div>
          ...
          <div className="d-flex gap-3 mt-4">
            ...
            <Button variant="outline-warning" size="lg" className="flex-fill fw-bold">
              Thêm vào giỏ
            </Button>
          </div>
        </Col>
          ...
          <Tab eventKey="specs" title="Thông số kỹ thuật">
            <table className="table table-bordered mt-3">
              <tbody>
                <tr>
                  <th>Trình độ chơi</th>
                  <td>{product.playerLevel === "advanced" ? "Trung Bình / Nâng Cao" : "Cơ bản"}</td>
                </tr>
                <tr>
                  <th>Phong cách chơi</th>
                  <td>{product.playingStyle === "offensive" ? "Tấn công" : "Phòng thủ"}</td>
                </tr>
                <tr>
                  <th>Chiều dài vợt</th>
                ...
                <tr>
                  <th>Độ cứng đũa</th>
                  <td>{product.shaftFlexibility === "extraStiff" ? "Cứng" : "Mềm"}</td>
                </tr>
                <tr>
                  <th>Điểm cân bằng</th>
                  <td>{product.balancePoint === "headHeavy" ? "Nặng đầu" : "Cân bằng"}</td>
                </tr>
                <tr>
                  <th>Trọng lượng</th>
