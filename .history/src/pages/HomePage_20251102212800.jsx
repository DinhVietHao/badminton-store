...
import { Carousel as BSCarousel, Card, Button, Spinner, Badge } from "react-bootstrap";
...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      {/* ========== Product Carousel ========== */}
      <section className="container my-5">
        <h2 className="fw-bold mb-4 border-start border-4 border-warning ps-3 text-white">
          Sản phẩm mới
        </h2>
