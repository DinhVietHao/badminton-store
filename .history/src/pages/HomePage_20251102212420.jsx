        ...
        <div className="row g-4">
          {products.map((product) => {
            ...
            return (
              ...
              >
                <Card
                  className="flex-fill shadow-sm border-0 rounded-3 hover-shadow transition-all position-relative overflow-hidden text-white"
                  style={{
                    backgroundColor: "#449D44", // ✅ chỉ màu nền cho thẻ Card
                  }}
                >
                  {discountPercent > 0 && (
                    <div
                  ...
                  <Card.Body>
                    <Card.Title
                      className="fs-6 text-truncate text-white"
                      title={product.title}
                    >
                      {product.title}
                    </Card.Title>
                    ...
                    <div className="mb-2">
                      <span className="text-warning fw-bold">{fmt(sale)}₫</span>{" "}
                      {original > 0 && (
